...
ET::$languageInfo["Portugues Brasil"] = array(
	"locale" => "pt-BR",
	"name" => "Português Brasil",
	"description" => "Português bruto, rústico e sistemático",
	"version" => '0.1',
	"author" => "Matheus Bona",
	"authorEmail" => "mateus.bona@gmail.com",
	"authorURL" => "http://www.bomnaweb.com.br",
	"license" => "GPLv2"
);
...
$definitions["date.full"] = "d/m/Y, G:i"; // see http://au.php.net/manual/en/function.date.php for details

$definitions["%d day ago"] = "ontem";
$definitions["%d days ago"] = "%d dias atrás";
$definitions["%d hour ago"] = "1 hora atrás";
$definitions["%d hours ago"] = "%d horas atrás";
$definitions["%d minute ago"] = "1 minuto atrás";
$definitions["%d minutes ago"] = "%d minutos atrás";
$definitions["%d month ago"] = "1 mês atrás";
$definitions["%d months ago"] = "%d meses atrás";
$definitions["%d second ago"] = "1 segundo atrás";
$definitions["%d seconds ago"] = "%d segundos atrás";
$definitions["%d week ago"] = "semana passada";
$definitions["%d weeks ago"] = "%d semanas atrás";
$definitions["%d year ago"] = "último ano";
$definitions["%d years ago"] = "%d anos atrás";

$definitions["%s and %s"] = "%s e %s";
$definitions["%s can view this conversation."] = "%s pode ver esse tópico.";
$definitions["%s changed %s's group to %s."] = "%s mudou o grupo %s's para %s.";
$definitions["%s changed your group to %s."] = "%s mudou seu grupo para %s.";
$definitions["%s conversation"] = "%s tópico";
$definitions["%s conversations"] = "%s tópicos";
$definitions["%s invited you to %s."] = "%s convidou você para %s.";
$definitions["%s joined the forum."] = "%s está participando do fórum.";
$definitions["%s post"] = "%s post";
$definitions["%s posted %s"] = "%s postou %s";
$definitions["%s posted in %s."] = "%s postado em %s.";
...
$definitions["%s tagged you in a post."] = "%s mencionou você em um post.";
$definitions["%s will be able to view this conversation."] = "'%s', agora é capaz de ver esse tópico.";
$definitions["%s will be able to:"] = "%s é capaz de:";

$definitions["A new version of esoTalk (%s) is available."] = "Uma nova versão do esoTalk (%s) está disponível.";
$definitions["a private conversation"] = "tópico privado";
$definitions["Access the administrator control panel."] = "Acesse o painel de administração";
$definitions["Account type"] = "Tipo de Conta";
$definitions["Activate"] = "Ativar";
$definitions["Activity"] = "Ativado";
...
$definitions["Administrator username"] = "Usuário do Administrador";
$definitions["Advanced options"] = "Opções avançadas";
$definitions["All Channels"] = "Todos os canais";
$definitions["Already have an account? <a href='%s' class='link-login'>Log in!</a>"] = "Já tem a sua conta? <a href='%s' class='link-login'>Acesse agora!</a>";
$definitions["Appearance"] = "Aparência";
$definitions["Automatically star conversations that I reply to"] = "Seguir automaticamente os tópicos que eu responder";
$definitions["Avatar"] = "Avatar";

$definitions["Back to channels"] = "Voltar aos canais";
$definitions["Back to conversation"] = "Voltar ao tópico";
$definitions["Back to member"] = "Voltar ao usuário";
$definitions["Back to members"] = "Volta aos usuários";
$definitions["Back to search"] = "Voltar a busca";
$definitions["Base URL"] = "URL Padrão";
$definitions["Bold"] = "Negrito";
$definitions["By %s"] = "Por %s";

$definitions["Can suspend/unsuspend members"] = "Pode bloquear/desbloquear usuários";
$definitions["Cancel"] = "Cancelar";
$definitions["Change %s's Permissions"] = "Alterar as permissões de %s's";
$definitions["Change avatar"] = "Alterar o avatar";
$definitions["Change channel"] = "Alterar o canal";
$definitions["Change name"] = "Alterar o nome";
$definitions["Change Password or Email"] = "Alterar a Senha ou E-mail";
$definitions["Change password"] = "Alterar a senha";
$definitions["Change permissions"] = "Alterar as permissões";
...
$definitions["Choose a secure password of at least %s characters"] = "Escolha uma senha segura com no mínimo %s caracteres";
$definitions["Choose what people will see when they first visit your forum."] = "Escolha o que os visitantes irão ver no primeiro acesso ao seu fórum.";
$definitions["Click on a member's name to remove them."] = "Clique no nome do usuário para removê-lo.";
$definitions["Close registration"] = "Fechar o registro";
$definitions["Confirm password"] = "Confirmar a Senha";
$definitions["Context"] = "Context";
$definitions["Controls"] = "Controles";
$definitions["Conversation"] = "Tópico";
$definitions["Conversations participated in"] = "Conversations participated in";
$definitions["Conversations started"] = "Tópicos iniciados";
$definitions["Conversations"] = "Tópicos";
$definitions["Copy permissions from"] = "Copiar permissões de";
$definitions["Create Channel"] = "Criar um Canal";
$definitions["Create Group"] = "Criar um Grupo";
$definitions["Create Member"] = "Criar um Usuário";
$definitions["Customize how users can become members of your forum."] = "Configure como os visitantes poderão se tornar usuários em seu fórum.";

$definitions["Dashboard"] = "Dashboard";
$definitions["Default forum language"] = "Idioma padrão do fórum";
$definitions["<strong>Delete</strong> all conversations forever."] = "<strong>Apagar</strong> todas as conversas.";
$definitions["Delete Channel"] = "Apagar Canal";
$definitions["Delete conversation"] = "Apagar Tópico";
$definitions["Delete member"] = "Apagar usuário";
$definitions["Delete Member"] = "Apagar Usuário";
$definitions["<strong>Delete this member's posts.</strong> All of this member's posts will be marked as deleted, but will be able to be restored manually."] = "<strong>Apagar as postagens desse usuário.</strong> Todos os posts desses usuários serão marcados como apagados, entretanto, pode ser restaurado manualmente.";
$definitions["Delete"] = "Apagar";
$definitions["Deleted %s by %s"] = "Apagado em %s por %s";
$definitions["Disable"] = "Desativado";
$definitions["Discard Draft"] = "Descartar Rascunhos";

$definitions["Edit Channel"] = "Editar Canal";
$definitions["Edit Group"] = "Editar Grupo";
$definitions["Edit member groups"] = "Editar grupos do usuário";
$definitions["Edit your profile"] = "Editar seu perfil";
$definitions["Edit"] = "Editar";
$definitions["Edited %s by %s"] = "Editado em %s por %s";
$definitions["Email me when I'm added to a private conversation"] = "Enviar um email quando for adicionado a um tópico privado";
$definitions["Email me when someone posts in a conversation I have starred"] = "Enviar um email quando alguém postar em um tópico que eu iniciei.";
$definitions["Email"] = "E-mail";
$definitions["Enable"] = "Ativado";
$definitions["Enter a conversation title"] = "Título do Tópico";
$definitions["Error"] = "Erro";
$definitions["esoTalk version"] = "Versão do esoTalk";
$definitions["Everyone"] = "Todos";

$definitions["Fatal Error"] = "Erro Fatal...";
$definitions["Feed"] = "Feed";
$definitions["Filter by name or group..."] = "Filtrar por nome ou grupo...";
$definitions["Filter conversations..."] = "Filtrar tópicos...";
$definitions["Find this post"] = "Buscar esse post";
$definitions["First posted"] = "Postado por primeiro";
$definitions["Forgot Password"] = "Esqueci minha senha";
$definitions["Forum header"] = "Cabeçalho do Fórum";
$definitions["Forum language"] = "Configurações de Idioma";
$definitions["Forum Settings"] = "Configs do Fórum";
$definitions["Forum Statistics"] = "Estatísticas do Fórum";
$definitions["Forum title"] = "Título do Fórum";
$definitions["forumDescription"] = "%s é um fórum discutindo %s, e %s.";

$definitions["Give this group the 'moderate' permission on all existing channels"] = "Conceder ao grupo a permissão de 'moderador' em todos os canais existentes";
$definitions["Global permissions"] = "Permissões Globais";
$definitions["Go to top"] = "Ir para o topo";
...
$definitions["group.guest"] = "Visitante";
$definitions["group.guest.plural"] = "Visitantes";
$definitions["group.member"] = "Usuário";
$definitions["group.member.plural"] = "Usuários";
$definitions["group.Moderator"] = "Moderador";
$definitions["group.Moderator.plural"] = "Moderadores";
$definitions["group.suspended"] = "Banido";
$definitions["Groups can be used to categorize members and give them certain privileges."] = "Grupos são usados para categorizar os usuários e dar a devida permissão.";
...
$definitions["If you run into any other problems or just want some help with the installation, feel free to ask for assistance at the <a href='%s'>esoTalk support forum</a>."] = "Se você tiver qualquer tipo de problema ou precisar de ajuda com a instalação fique a vontade para perguntas no <a href='%s'>Fórum de Suporte esoTalk</a>.";
...
$definitions["Jump to last"] = "Ir para o fim do tópico";
$definitions["Jump to unread"] = "Ir para os não lidos";
$definitions["just now"] = "agora mesmo";

$definitions["<strong>Keep this member's posts.</strong> All of this member's posts will remain intact, but will show [deleted] as the author."] = "<strong>Manter os posts desses usuários.</strong> Todos os posts desses usuários não serão modificados, porém será mostrado o status [deletado] como seu autor.";

$definitions["label.draft"] = "Rascunho";
$definitions["label.locked"] = "Bloqueado";
$definitions["label.muted"] = "Encerrado";
$definitions["label.private"] = "Privado";
$definitions["label.sticky"] = "Unido";
$definitions["Labels"] = "Títulos";
$definitions["Last active %s"] = "Último acesso %s";
$definitions["Latest News"] = "Últimas Notícias";
$definitions["Loading..."] = "Carregando...";
$definitions["Lock"] = "Bloquear";
$definitions["Log In"] = "Acessar";
$definitions["Log Out"] = "Sair";

$definitions["Manage Groups"] = "Configurar Grupo";
...
$definitions["Member groups"] = "Grupos de Usuário";
$definitions["Member List"] = "Lista de Usuários";
$definitions["Members Allowed to View this Conversation"] = "Usuários com permissão para ver esse tópico";
$definitions["Members Online"] = "Usuários Online";
$definitions["Members"] = "Usuários";
$definitions["Mobile skin"] = "Skin para celular";
$definitions["Moderate"] = "Moderar";
$definitions["<strong>Move</strong> conversations to the following channel:"] = "<strong>Mover</strong> tópicos para o canal:";
$definitions["Mute conversation"] = "Encerrar tópico";
$definitions["MySQL database"] = "Nome do banco de dados MySQL";
$definitions["MySQL host address"] = "Endereço do Host MySQL";
$definitions["MySQL password"] = "Senha do Usuário MySQL";
$definitions["MySQL queries"] = "MySQL queries";
$definitions["MySQL table prefix"] = "Prefixo de Tabela MySQL";
$definitions["MySQL username"] = "Nome do Usuário MySQL";
$definitions["MySQL version"] = "Versão do MySQL";

$definitions["Name"] = "Nome";
$definitions["never"] = "nunca";
$definitions["New Conversation"] = "Novo Tópico";
$definitions["New conversations in the past week"] = "Novos tópicos na última semana";
$definitions["New email"] = "Novo e-mail";
$definitions["New members in the past week"] = "Novos usuários na última semana";
$definitions["New password"] = "Nova senha";
$definitions["New posts in the past week"] = "Novos posts na última semana";
...
$definitions["online"] = "online";
$definitions["Open registration"] = "Registro liberado";
$definitions["optional"] = "opcional";
$definitions["Order By:"] = "Ordenado por:";
$definitions["Original Post"] = "Post Original";
...
$definitions["Preview"] = "Visualizar";
$definitions["Previous"] = "Anterior";

$definitions["quote"] = "citar";

$definitions["Read more"] = "Leia mais";
$definitions["Recent posts"] = "Posts recentes";
$definitions["Recover Password"] = "Recuperar senha";
$definitions["Registration"] = "Registrar";
$definitions["Remove avatar"] = "Remover avatar";
$definitions["Rename Member"] = "Remover Usuário";
$definitions["Reply"] = "Responder";
$definitions["Report a bug"] = "Reportar um bug";
$definitions["Require users to confirm their email address"] = "Exigir que os usuários confirmem seu endereço de email";
$definitions["restore"] = "restaurar";

$definitions["Save Changes"] = "Salvar Alterações";
$definitions["Save Draft"] = "Salvar Rascunhos";
$definitions["Search conversations..."] = "Buscar tópicos...";
$definitions["Search within this conversation..."] = "Buscar no tópico...";
$definitions["Search"] = "Buscar";
$definitions["See the private conversations I've had with %s"] = "Ver os tópicos privados com %s";
...
$definitions["Show the conversation list by default"] = "Mostrar a lista de tópicos por padrão";
$definitions["Show the forum title in the header"] = "Mostrar o título do fórum no cabeçalho";
$definitions["Sign Up"] = "Cadastrar-se";
$definitions["Skins"] = "Skins";
$definitions["Specify Setup Information"] = "Especificar informações de instalação";
$definitions["Star to receive notifications"] = "Ir para notificações recebidas";
$definitions["Starred"] = "Following";
$definitions["Start a conversation"] = "Começar um tópico";
$definitions["Start a private conversation with %s"] = "Começar um tópico privado com %s";
$definitions["Start Conversation"] = "Começar Tópico";
$definitions["Starting a conversation"] = "Começar o tópico";
$definitions["Statistics"] = "Estatísticas";
$definitions["statistic.conversation.plural"] = "%s tópicos";
$definitions["statistic.conversation"] = "%s tópico";
$definitions["statistic.member.plural"] = "%s usuários";
$definitions["statistic.member"] = "%s usuário";
...
$definitions["Subscribed"] = "Assinado";
$definitions["Subscription"] = "Assinatura";
$definitions["Suspend member"] = "Banir usuário";
$definitions["Suspend members."] = "Banir usuários.";
$definitions["Suspend"] = "Banir";

$definitions["Uninstall"] = "Desinstalar";
$definitions["Unlock"] = "Desbloquear";
$definitions["Unmute conversation"] = "Re-abrir tópico";
$definitions["Unstarred"] = "Não seguir";
$definitions["Unsticky"] = "Unsticky";
$definitions["Unsubscribe new users by default"] = "Usar 'não assinado' por padrão para novos usuários";
$definitions["Unsubscribed"] = "Não assinado";
$definitions["Unsuspend member"] = "Desbloquear Usuário";
$definitions["Unsuspend"] = "Desbloquear";
$definitions["Untitled conversation"] = "Tópico sem título";
$definitions["Upgrade esoTalk"] = "Atualizar esoTalk";
$definitions["Use for mobile"] = "Usuar para Dispositivos Móveis";
$definitions["Use friendly URLs"] = "Usar URLs amigáveis";
$definitions["Used to verify your account and subscribe to conversations"] = "Usado para verificar sua conta e assinar tópicos";
...
$definitions["Viewing: %s"] = "Vendo: %s";
$definitions["viewingPosts"] = "<b>%s-%s</b> of %s posts";

$definitions["Warning"] = "Algo não está certo!";
$definitions["Write a reply..."] = "Escrever uma resposta...";

$definitions["Yes"] = "Sim";
$definitions["You can manage channel-specific permissions on the channels page."] = "Você pode definir permissões específicas para cada canal na página de canais.";
...
$definitions["email.confirmEmail.subject"] = "%1\$s, por favor, confirme seu endereço de email";
$definitions["email.footer"] = "\n\n(Se você não deseja receber esse tipo de emails, <a href='%s'>clique aqui</a>.)";
...
$definitions["email.forgotPassword.subject"] = "Você esqueceu sua senha, %1\$s?";
$definitions["email.header"] = "Olá %s!\n\n";
$definitions["email.mention.body"] = "%1\$s mencionou você no tópico '%2\$s'.\n\nPara ver o post, use o link abaixo:\n%3\$s";
$definitions["email.mention.subject"] = "%1\$s mentioned you in a post";
$definitions["email.privateAdd.body"] = "Você foi adicionado a um tópico privado de título '%1\$s'.\n\nPara ver esse tópico, use o link abaixo:\n%2\$s";
$definitions["email.privateAdd.subject"] = "Você foi adicionado a um tópico privado.";
$definitions["email.replyToStarred.body"] = "%1\$s respondeu o tópico que você está seguindo: '%2\$s'.\n\nPara ver a resposta, use o link abaixo:\n%3\$s";
$definitions["email.replyToStarred.subject"] = "A uma nova resposta para '%1\$s'";
...
$definitions["gambit.contributor:"] = "contribuição:";
$definitions["gambit.member"] = "usuário";
$definitions["gambit.myself"] = "eu mesmo";
$definitions["gambit.draft"] = "rascunho";
$definitions["gambit.has attachments"] = "tem anexos";
$definitions["gambit.locked"] = "bloqueado";
$definitions["gambit.order by newest"] = "ordenar pelo mais novo";
$definitions["gambit.order by replies"] = "ordenar por respostas";
$definitions["gambit.private"] = "privado";
$definitions["gambit.random"] = "casual";
$definitions["gambit.reverse"] = "reverter";
$definitions["gambit.starred"] = "seguido";
$definitions["gambit.muted"] = "encerrado";
$definitions["gambit.sticky"] = "sticky";
$definitions["gambit.unread"] = "Não lido";
$definitions["gambit.more results"] = "mais resultados";
...
$definitions["gambit.active today"] = "entrou hoje"; // what appears in the gambit cloud
$definitions["gambit.active 1 day"] = "entrou a 1 dia"; // what it actually evaluates to
...
$definitions["gambit.dead"] = "encerrado";
$definitions["gambit.active >30 day"] = "entrou a >30 dias";
...
$definitions["gambit.last"] = "último"; // as in "active last 180 days"
$definitions["gambit.active"] = "entrou"; // as in "active last 180 days"
